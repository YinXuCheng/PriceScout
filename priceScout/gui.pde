...
public void createGUI(){
  ...
  numPeoples = new GCustomSlider(window1, 22, 41, 200, 40, "grey_blue");
  ...
  label1 = new GLabel(window1, 9, 12, 200, 20);
  ...
  speedValue = new GCustomSlider(window1, 19, 143, 200, 40, "grey_blue");
  ...
  storeNum = new GCustomSlider(window1, 20, 244, 200, 40, "grey_blue");
  ...
  label3 = new GLabel(window1, 353, 15, 80, 20);
  label3.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label3.setText("Ratings");
  label3.setOpaque(false);
  ratingValue = new GCustomSlider(window1, 291, 38, 200, 40, "grey_blue");
  ...
  label4 = new GLabel(window1, 347, 125, 80, 20);
  label4.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label4.setText("Price");
  label4.setOpaque(false);
  priceValue = new GCustomSlider(window1, 292, 143, 200, 40, "grey_blue");
  ...
  label5 = new GLabel(window1, 345, 211, 80, 20);
  label5.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  label5.setText("Competition");
  label5.setOpaque(false);
  custom_slider3 = new GCustomSlider(window1, 289, 242, 200, 40, "grey_blue");
